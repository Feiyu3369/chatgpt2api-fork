...
<p align="center"><strong>当前稳定版本：v2.4.4</strong> | <a href="https://github.com/yukkcat/chatgpt2api/releases/tag/v2.4.4">发布说明</a> | <a href="https://github.com/yukkcat/chatgpt2api/releases">全部版本</a></p>
...
```bash
curl -fsSL https://raw.githubusercontent.com/yukkcat/chatgpt2api/v2.4.4/deploy/install.sh | sudo bash -s -- --branch v2.4.4
```
